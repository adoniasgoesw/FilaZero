        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[70vh]">
          <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
            <div className="mb-6">
              ...
              <div className="w-16 h-0.5 bg-red-500 mx-auto lg:mx-0"></div>
            </div>

            <h2 className="text-5xl lg:text-6xl font-bold text-gray-800 mb-6 leading-tight">
              Seu cliente <span className="text-red-500">não espera</span>,<br />
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              <AccessButton onClick={onPrimaryClick} variant="red">Começar Agora</AccessButton>
            </div>
          </div>
